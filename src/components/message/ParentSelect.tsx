...
import { createParentNameSelectOptions } from "../../utils/MessageUtils";

type state = {
  parentFormStateHandler: (obj: any) => void;
};

export default class ParentSelect extends React.Component<state> {
  ...
  handleChange = (selectedOption: any) => {
    ...
    this.parentFormStateHandler({
      selectedParent: explicitSelectedOption.value,
    });
  };

  async componentDidMount(): Promise<void> {
    const selectOptions: SelectOption[] = await createParentNameSelectOptions();
    this.setState({
